...
def dieback_detection(
    ...
    tile.add_path("confirmation_date_dieback", tile.data_directory / "DataDieback" / "confirmation_date_dieback.tif")
    ...
    write_tif(dieback_data["confirmation_date"], first_detection_date_index.attrs,tile.paths["confirmation_date_dieback"],nodata=0)
